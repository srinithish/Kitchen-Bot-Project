...
a = arm.get_servo_angle(is_radian=False)
arm.set_servo_angle( angle=[a[1][0],a[1][1],a[1][2],a[1][3],a[1][4],a[1][5],a[1][6]+90],
                     speed=None, mvacc=None, mvtime=None, is_radian=False,wait=True)

arm.set_gripper_position(500, wait=True)

arm.set_servo_angle( angle=[a[1][0],a[1][1],a[1][2],a[1][3],a[1][4],a[1][5],a[1][6]],
                     speed=None, mvacc=None, mvtime=None, is_radian=False,wait=True)
